          ...
          <div className="modal-dialog modal-lg">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">{editId ? 'Edit Worker' : 'Add Worker'}</h5>
              ...
              <div className="mt-4 text-end">
                ...
                <button className="btn btn-primary" type="submit">{editId ? 'Update Worker' : 'Add Worker'}</button>
              </div>
            </form>
          </div>
        </div>
                ...
                <tbody>
                  {displayedWorkers.map((worker, index) => (
                    <tr key={worker.id}>
                      ...
                      <td>{worker.salary}</td>
                      <td>
                        <div>{formatDateTime(worker.created_at)}</div>
                        <div>{formatDateTime(worker.updated_at)}</div>
                      </td>
                      {user.role === 'admin' && (
                        <td>
